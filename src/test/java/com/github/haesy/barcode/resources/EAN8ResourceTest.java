...
@QuarkusTest
public class EAN8ResourceTest
{
    private static final String PATH = "/ean-8";

    @Test
    public void testValid()
    {
        given().queryParam(CONTENT, "1234567").when().get(PATH).then().statusCode(200).header(CONTENT_TYPE, IMAGE_PNG);
    }
